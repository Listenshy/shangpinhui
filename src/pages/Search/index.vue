  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @trademarkInfo="trademarkInfo" @attr="attr" />
        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <!-- active 背景颜色 -->
                <li :class="{ active: isOne }" @click="zonghe">
                  <a
                    >综合
                    <span
                      v-show="isOne"
                      ...
                      @click.stop="shengjiang('1')"
                    ></span>
                  </a>
                </li>
                <li :class="{ active: isTwo }" @click.stop="jiage">
                  <a
                    >价格
                    <span
                      v-show="isTwo"
